...
@InputType()
class StudentCreateNestedManyWithoutClassModelsInput {
...
export { StudentCreateNestedManyWithoutClassModelsInput as StudentCreateNestedManyWithoutClassModelsInput };
